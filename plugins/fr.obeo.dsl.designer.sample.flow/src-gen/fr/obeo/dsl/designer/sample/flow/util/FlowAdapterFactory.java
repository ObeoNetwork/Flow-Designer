...
public class FlowAdapterFactory extends AdapterFactoryImpl {
	...
	protected FlowSwitch<Adapter> modelSwitch =
		new FlowSwitch<Adapter>() {
            @Override
            public Adapter caseStateProcessor(StateProcessor object) {
                return createStateProcessorAdapter();
            }
            @Override
            ...
            @Override
            public Adapter caseComputationResult(ComputationResult object) {
                return createComputationResultAdapter();
            }
            @Override
	...
	/**
     * Creates a new adapter for an object of class '{@link fr.obeo.dsl.designer.sample.flow.StateProcessor <em>State Processor</em>}'.
     * <!-- begin-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link fr.obeo.dsl.designer.sample.flow.State <em>State</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link fr.obeo.dsl.designer.sample.flow.ComputationResult <em>Computation Result</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link fr.obeo.dsl.designer.sample.flow.Event <em>Event</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link fr.obeo.dsl.designer.sample.flow.Operation <em>Operation</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

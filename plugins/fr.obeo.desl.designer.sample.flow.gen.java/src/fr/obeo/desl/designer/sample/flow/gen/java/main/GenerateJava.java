 ...
 *******************************************************************************/
package fr.obeo.desl.designer.sample.flow.gen.java.main;
...
public class GenerateJava extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fr/obeo/desl/designer/sample/flow/gen/java/main/generateJava";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(fr.obeo.dsl.designer.sample.flow.FlowPackage.class)) {
            resourceSet.getPackageRegistry().put(fr.obeo.dsl.designer.sample.flow.FlowPackage.eINSTANCE.getNsURI(), fr.obeo.dsl.designer.sample.flow.FlowPackage.eINSTANCE);
        }
